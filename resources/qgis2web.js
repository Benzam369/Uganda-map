...
map.getView().fit([3262688.569666, -110495.561617, 3798294.770712, 141651.078250], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UGANDA MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (58 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Produced by GIS Unit, ICT Directorate, Uganda Police Force';
            }
